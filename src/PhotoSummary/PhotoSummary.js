        ...
        return ( 
            <section className="PhotoSummary">
                    <div className="Personal_Pic_Div">
                        <img className="Personal_Pic" src="https://imgur.com/coyRz4k.jpg" alt="Me with beach town in the background"></img>
                    </div>
                    <article id="Contact">
                        <div className="PhotoSummary_Bio">
                            ...
                            <div className="PhotoSummary_Icons">
                                ...
                                <button className="logo_button email_logo_button">
                                        <FontAwesomeIcon className="logo_email" icon={faEnvelopeSquare} />
                                </button>
                                    </a>
                                    <a
