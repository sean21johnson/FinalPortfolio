            ...
            <div className="Project_Item">
                ...
                <div className="ProjectItem_Info_Div">
                    ...
                    <div className="ProjectItem_Info_Tech">
                        ...
                        <p className="ProjectItem_Paragraph"><strong className="Tech_strong">Tech Stack: </strong>{techstack}</p>
                    </div>
                    <div className="ProjectItem_Info_Buttons">
                        ...
                        <button className="Repo_Button">
                            <FontAwesomeIcon className="logo_github_project" icon={faGithub} />  REPO
                        </button>
                            </a>
                    </div>
                </div>
