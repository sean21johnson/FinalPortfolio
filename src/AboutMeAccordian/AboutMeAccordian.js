			...
			<ReactBootStrap.Accordion className="theAccordian" defaultActiveKey="0">
				<ReactBootStrap.Card>
					...
					<ReactBootStrap.Accordion.Collapse eventKey="0">
						<ReactBootStrap.Card.Body className="Accordian_Body">
							Frontend engineer based in Philadelphia, PA who is skilled
							skilled in writing clean, testable, and thoroughly documented
							code. NYU Stern MBA with a broad understanding of business.
				...
				<ReactBootStrap.Card>
					...
					<ReactBootStrap.Accordion.Collapse eventKey="1">
						<ReactBootStrap.Card.Body className="Accordian_Body">
						<h4 className="Role_Header">Frontend Engineer @ <a href="https://www.zenhub.com/" target="_blank">ZenHub</a></h4>
						Delivered key contributions to ZenHub code base which improved UX &
						 UI of the web application and browser extension. Utilized frontend technologies 
					...
					<ReactBootStrap.Accordion.Collapse eventKey="2">
						<ReactBootStrap.Card.Body className="Accordian_Body">
							<ul className="Accordian_List">
								<li>
									<strong>Front End: </strong>JavaScript, React, TypeScript, Redux, jQuery, HTML,
									CSS, Bootstrap
								</li>
								<li>
								...
								<li>
									<strong>Testing: </strong>Jest/Enzyme/React Testing Library on the frontend and
									Mocha/Chai on the backend
								</li>
							</ul>
						</ReactBootStrap.Card.Body>
					</ReactBootStrap.Accordion.Collapse>
				...
				<ReactBootStrap.Card>
					...
					<ReactBootStrap.Accordion.Collapse eventKey="3">
						<ReactBootStrap.Card.Body className="Accordian_Body">
							...
							stakeholders by leveraging highly
				...
				<ReactBootStrap.Card>
					...
					<ReactBootStrap.Accordion.Collapse eventKey="4">
						<ReactBootStrap.Card.Body className="Accordian_Body">
							<ul className="Accordian_List">
								<li>
									Frontend Engineer @ ZenHub since October 2021
								</li>
								<li>
									Thinkful Software Engineering Immersive Program 2021 graduate
								</li>
								<li>
									NYU Stern School of Business 2018 MBA graduate
								</li>
